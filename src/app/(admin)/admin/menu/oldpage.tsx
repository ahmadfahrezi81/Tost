        ...
        <>
            <div className="flex items-center justify-between px-14 py-10">
                ...
                <div className="flex w-fit">
                    <Link
                        href="./menu/new"
                        className="flex items-center justify-center gap-2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-8 pl-6 py-2.5"
                    >
                        <Icons.Plus />
                        <span>Add</span>
                    </Link>
            ...
            <div className="relative mx-14 overflow-auto">
                <table className="w-full text-sm table-fixed text-left text-gray-700">
                    ...
                    <tbody>
                        ...
                        <tr className="border-t-2 border-b-2 border-gray-200">
                            ...
                            <td className="px-6 py-4 truncate">
                                Bread, boiled egg, sliced avocado, pepper, mix
                                herb, oil
                            </td>
                            <td className="py-4 px-6 space-x-3">
                                <div className="flex flex-row gap-3">
                        ...
                        <tr className="border-t-2 border-b-2 border-gray-200">
                            ...
                            <td className="px-6 py-4 truncate">
                                Bread, salmon, boiled egg, oregano, pepper,
                                walnuts
                            </td>
                            <td className="py-4 px-6 space-x-3">
                                <div className="flex flex-row gap-3">
                        ...
                        <tr className="border-t-2 border-b-2 border-gray-200">
                            ...
                            <td className="px-6 py-4">RM 15</td>
                            <td className="px-6 py-4 truncate">
                                Bread, ice cream, whipped cream, lemon,
                                chocolate powder
                            </td>
                            <td className="py-4 px-6 space-x-3">
                                <div className="flex flex-row gap-3">
