    ...
    <>
      <div className="relative mt-12 mx-4 mr-4 overflow-auto">
        <div className="flex flex-col justify-between items-center">
          <caption className="p-5 text-3xl font-bold text-black ">
            User Info
          </caption>
          <table className="w-full text-sm table-fixed text-left text-gray-700">
            ...
            <tbody>
              <tr className="border-t-2 border-b-2 border-gray-200">
                ...
                <td className="py-4 px-6 space-x-3">
                  <div className="flex flex-row gap-3">
                    ...
                    <button className="font-medium text-red-600" onClick={() => setShowModal(true)}>
                      <svg
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
              ...
              <tr className="border-t-2 border-b-2 border-gray-200">
                ...
                <td className="py-4 px-6 space-x-3">
                  <div className="flex flex-row gap-3">
                    <button onClick={() => setShowGreenModal(true)} className="font-medium text-blue-600">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
                    ...
                    <button onClick={() => setShowModal(true)} className="font-medium text-red-600">
                      <svg
                        fill="none"
                        stroke="currentColor"
                        stroke-width="1.5"
      ...
      <GreenModal visible={showGreenModal} title="test" level="edit_customer" onClose={() => setShowGreenModal(false)}/>
      <WarningModal visible={showModal} title="Watch out!" level="account" onClose={() => setShowModal(false)}/>
    </>
  );
};
