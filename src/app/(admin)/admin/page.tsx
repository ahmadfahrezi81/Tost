...
const page: FC = ({}) => {
    return <div className="m-10 font-sans">
        <div>
        ...
        <div className="flex flex-row mb-16">
            <div className="basis-3/5 flex-row">
                <div className="flex w-full justify-between mb-2 items-center">
                    <h3 className="font-bold text-3xl text-custom-green">Booked Table</h3>
            ...
            <div className="basis-2/5 w-full pl-16">
                <div>
                    <h2 className="font-bold text-3xl text-custom-green mb-2">Pending Order</h2>
                </div>
        ...
        <div className="font-sans">
            <h2 className="font-bold text-3xl text-custom-green mb-2 ">Daily Revenue</h2>
