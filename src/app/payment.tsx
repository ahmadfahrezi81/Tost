        ...
        <div className='container px-7 py-7'>
          ...
          <div className='flex flex-row gap-x-20'>
            <div className='flex items-center mb-4'>
              <input id="payment-option-1" type="radio" name="countries" value="CCorDC" className='h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300 mr-2' aria-labelledby="country-option-1" aria-describedby="country-option-1" />
              <Image
                src={cc}
                alt="CC or Debit"
                height={16}
            ...
            <div className="flex items-center mb-4">
              <input id="payment-option-2" type="radio" name="countries" value="FPX" className='h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300 mr-2' aria-labelledby="country-option-1" aria-describedby="country-option-1"/>
              <Image
                src={fpx}
                alt="FPX"
                height={32}
