  ...
  return (
    <>
      <div className="flex flex-col h-full md:flex-row">
            ...
            <div className="text-white font-semibold">
              <div className="flex flex-col mb-5">
                ...
                <div className="plsChoose italic text-gray-300 text-xs font-normal mb-3">
                  *Please use the button below to choose the number of diners
                </div>
                <div>
                  <Counter />
                </div>
              ...
              <div className="flex flex-col mb-5">
                ...
                <div className="text-sm font-medium align-middle text-right">
                  Reserving for <span className="font-bold">{currDate}</span>
                </div>
              </div>
            </div>
        ...
        <div className="basis-1/2 font-sans m-10 flex-col flex justify-between">
          <div>
          ...
          <div>
            <div className="mb-5">
              <label
                /*for="message"*/ className="block mb-2 text-sm font-medium text-gray-900"
              >
                Notes
              </label>
              <textarea
