...
const page = ({}) => {
  return (
    <div className="flex flex-col container my-20 mx-auto items-center px-36">
      ...
      <div className="flex flex-col px-96 pb-6">
        <label
        ...
        <input
          ...
          className="items-center bg-zinc-300 text-zinc-600 text-sm rounded-lg block p-2.5 w-[20rem] font-semibold cursor-not-allowed"
        ...
        <div className="relative left-0 pt-3">
          <button
            type="button"
            className="w-fit text-emerald-800 hover:text-white border border-emerald-800 hover:bg-emerald-800 focus:outline-none font-medium rounded-lg text-sm px-3 py-2.5 text-center"
          >
            Change Email
          </button>
        </div>
