...
const page: FC = ({}) => {
    return (
        <>
        <h1 className="flex mt-11 text-5xl font-bold justify-center leading-none tracking-tight text-gray-900">Menu</h1>
            <div className="h-screen grid grid-cols-4 auto-cols-max gap-10 gap-x-0 mx-10 my-10 justify-items-center">
                <Link href="/user/menu/id" className="flex flex-col max-w-sm p-6 items-center">
                    <Image src={Bacon} alt="" width={300} height={300} />
                    <p className="relative text-center mt-8 text-3xl font-semibold">
                        Bacon & Egg Tost
                    </p>
                </Link>
                <Link href="/user/menu/id" className="flex flex-col max-w-sm p-6 items-center">
