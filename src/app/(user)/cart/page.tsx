        ...
        <table className="w-full text-sm text-left text-gray-500">
          ...
          <tbody>
            <tr className="bg-white border-b  ">
              ...
              <td className="px-6 py-4 font-bold text-gray-900 ">McBandung</td>
              ...
              <td className="px-6 py-4 font-semibold text-gray-900 ">RM 30</td>
              <td className="px-6 py-4 font-semibold text-gray-900">RM 30</td>
            </tr>
          </tbody>
        </table>
          ...
          <div className="w-1/2 rounded overflow-hidden shadow-lg">
            <div className="px-6 py-4">
              ...
              <div className="flex justify-between mt-4">
                ...
                <p className="text-gray-700 text-base">RM 30.00</p>
              </div>
              <div className="flex justify-between mt-4">
                <p className="text-gray-700 text-base">Tax Service</p>
                <p className="text-gray-700 text-base">RM 1.00</p>
              </div>
