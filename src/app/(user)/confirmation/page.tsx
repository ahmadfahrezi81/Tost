    ...
    return (
        <div className="relative mt-12 mx-60 mr-16 overflow-auto">
            ...
            <div className="flex justify-center items-center mt-9">
                <button
                    type="button"
                    className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg "
                >
                    Print Receipt
                </button>
            </div>
