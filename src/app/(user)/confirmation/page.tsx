  ...
  return (
    <div className="relative overflow-x-auto sm:rounded-lg">
      ...
      <div className="flex justify-center items-center mt-9">
        <button
          type="button"
          className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none text-white bg-custom-orange hover:bg-custom-red-hov focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2"
        >
          Print Receipt
        </button>
      </div>
